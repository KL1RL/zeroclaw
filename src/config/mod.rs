...
pub use schema::{
    ...
    GoogleWorkspaceConfig, HardwareConfig, HardwareTransport, HeartbeatConfig, HomeAssistantConfig,
    HomeAssistantWriteChannelConfig, HooksConfig, HttpRequestConfig, IMessageConfig,
